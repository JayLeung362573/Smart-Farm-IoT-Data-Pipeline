...
The benchmark runs the sensor simulator and PostgreSQL ingestion workers through Docker Compose. It records generated readings, queue drops, elapsed time, and producer throughput. Results vary by machine and runtime environment, so these numbers are presented as local examples rather than production performance claims.

| Sensors | Workers | Batch Size | Duration | Generated Readings | Dropped Readings | Producer Throughput |
| --- | --- | --- | --- | --- | --- | --- |
| 100 | 2 | 50 | 20s | 2,037 | 0 | 101.25 readings/sec |
| 500 | 5 | 100 | 30s | 15,295 | 0 | 508.51 readings/sec |
| 1,000 | 8 | 100 | 30s | 30,691 | 0 | 1,019.88 readings/sec |

All three local runs completed with zero queue drops. The reported throughput measures readings generated by the simulator. It is not a direct measurement of committed PostgreSQL rows per second.
